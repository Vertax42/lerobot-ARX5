...
class SingleArm:
    ...
    def go_home(self) -> bool:
        ...
        """
        self.arm.set_arm_status(1)  # go_home state
        return True

    def gravity_compensation(self) -> bool:
        self.arm.set_arm_status(3)  # gravity compensation state
        return True

    def protect_mode(self) -> bool:
        self.arm.set_arm_status(2)  # protect mode state
        return True
    ...
    def set_joint_positions(
        ...
        **kwargs,
        ...
        self.arm.set_arm_status(5)  # position control state
    ...
    def set_ee_pose(
        ...
        **kwargs,
        ...
        self.arm.set_arm_status(4)  # End effector pose control state
