...
lerobot-record \
 ...
 --teleop.id=vertax_leader_arm \
 --display_data=true \
 --dataset.repo_id=Vertax/xense-so101-test \
 --dataset.num_episodes=10 \
 --dataset.single_task="Grab multipule cubes and stack"

lerobot-train \
 --dataset.repo_id=Vertax/xense-so101-test \
 --policy.type=act \
 --output_dir=outputs/train/act_xense-so101-test \
 --job_name=act_xense-so101-test \
 --policy.device=cuda \
 --wandb.enable=true \
 --policy.repo_id=Vertax/act_xense-so101-test_policy
...
lerobot-record \
 ...
 --robot.id=vertax_follower_arm \
 --display_data=false \
 --dataset.repo_id=Vertax/eval_xense-so101-test \
 --dataset.single_task="Grab multipule cubes and stack" \
 --teleop.type=so101_leader \
 --teleop.port=/dev/ttyACM0 \
 --teleop.id=vertax_leader_arm \
 --policy.path=Vertax/act_xense-so101-test_policy
